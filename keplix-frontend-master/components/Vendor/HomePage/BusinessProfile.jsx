...
export default function BusinessProfile ({ navigation }) {
  const [shopName, setShopName] = useState('Dwarka Mor Service');
  const [location, setLocation] = useState('B1-41, Chandan park, Dwarka...');
  const [contactNumber, setContactNumber] = useState('+919123456789');
  const [operatingHours, setOperatingHours] = useState('10:00AM – 7:30PM');

  const handleSaveChanges = () => {
    console.log('Changes Saved:', { shopName, location, contactNumber, operatingHours });
  };
