...
export default function VendorSupport({ navigation }) {
 ...
 const renderMessage = ({ item }) => {
  ...
  const timeAlignment = isMe ? "right" : "left";
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <Text style={styles.title}>Vendor Support</Text>
      <Text style={styles.subtitle}>App-related or business issues</Text>
