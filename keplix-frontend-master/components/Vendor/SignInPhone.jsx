  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <TouchableOpacity style={styles.sendOtpButton}>
        <Text style={styles.sendOtpButtonText} onPress={()=> navigation.navigate("SignInPhoneOTP")}>Send OTP</Text>
      </TouchableOpacity>
      ...
      <TouchableOpacity style={styles.emailButton}>
        <Text style={styles.emailButtonText}>Sign in using E-mail</Text>
      </TouchableOpacity>
