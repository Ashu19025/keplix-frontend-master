...
export default function CustomerChat({ navigation, route }) {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.userInfoContainer}>
        <Image source={customerDetails.image} style={styles.userPhoto} />
        <Text style={styles.userName}>{customerDetails.name}</Text>
      </View>
